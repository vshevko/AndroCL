  ...
  (JNIEnv* env, jclass , jlong self, jlong trainData_nativeObj, jint flags)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::StatModel>* me = (Ptr<cv::ml::StatModel>*) self; //TODO: check for NULL
        bool _retval_ = (*me)->train( Ptr<cv::ml::TrainData>((cv::ml::TrainData*)trainData_nativeObj), (int)flags );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong trainData_nativeObj)
{
    ...
    try {
        LOGD("%s", method_name);
        Ptr<cv::ml::StatModel>* me = (Ptr<cv::ml::StatModel>*) self; //TODO: check for NULL
        bool _retval_ = (*me)->train( Ptr<cv::ml::TrainData>((cv::ml::TrainData*)trainData_nativeObj) );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong data_nativeObj, jboolean test, jlong resp_nativeObj)
{
    ...
    try {
        ...
        float _retval_ = (*me)->calcError( Ptr<cv::ml::TrainData>((cv::ml::TrainData*)data_nativeObj), (bool)test, resp );
        return _retval_;
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
